...
interface UserContextValue {
  ...
  loading: boolean;
  updateProfile: (updates: Partial<Omit<UserProfile, "userId">>) => void;
  completeOnboarding: (name: string, role: string) => void;
}
...
export function UserProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <UserContext.Provider value={{ profile, loading, updateProfile, completeOnboarding }}>
      {children}
